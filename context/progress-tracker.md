...
- Editor chrome base components are complete. Define and start the next feature unit (e.g. the editor page/layout that composes navbar + sidebar + canvas, or canvas foundations).
